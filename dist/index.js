...
import { saveMessage, markMessagesExtracted, quarantineMessages, recordExtractionFailure, upsertNode, upsertEdge, findByName, updateNode, getStats, upsertTurnMemory, getRecentTurnMemoriesBySession, replaceNavigationTriples, } from "./src/store/store.js";
    ...
    register(api) {
            ...
            const next = prev.then(async () => {
                ...
                try {
                    ...
                    embeddingReady
                        ...
                        .catch(() => { });
                    markMessagesExtracted(db, messageIds);
                    api.logger.info(`[graph-memory] stored one turn summary and ${result.triples.length} navigation triples ` +
        ...
        api.registerTool((_ctx) => ({
            ...
            async execute(_toolCallId, params) {
                ...
                const tripleLines = res.triples.map(triple => `${triple.subject} --[${triple.predicate}]--> ${triple.object}`);
